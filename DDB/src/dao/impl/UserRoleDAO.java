...
import domain.UserRoleId;

/**
 * A data access object (DAO) providing persistence and search support for UserRole entities. Transaction control of the save(), update() and delete() operations can directly support Spring container-managed transactions or they can be augmented to handle user-managed Spring transactions. Each of these methods provides additional information for how to configure it for the desired type of transaction control.
 * 
 * @see domain.UserRole
...
public class UserRoleDAO extends HibernateDaoSupport {
	...
	public UserRole findById(domain.UserRoleId id) {
